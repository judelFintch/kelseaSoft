<div>
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Edit Permission: {{ $display_name ?? $name }}</h2>
            </div>
            <div class="mt-4 text-sm text-gray-600">
                <p><strong>Note:</strong> Permissions are often managed by developers directly in the code or through seeders. Modifying permissions dynamically here might be an advanced feature. Ensure you understand the implications for your application's authorization logic, especially when changing the 'Name (Code)' of a permission.</p>
            </div>
            ...
            <form wire:submit.prevent="updatePermission" class="mt-6">
