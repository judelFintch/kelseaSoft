        ...
        <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <a href="{{ route('invoices.generate') }}" class="inline-flex items-center justify-center gap-2.5 rounded-md bg-success px-4 py-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-4">
