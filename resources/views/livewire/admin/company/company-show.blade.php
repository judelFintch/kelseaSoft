<div>
    <main>
        <div class="p-4 mx-auto max-w-screen-2xl md:p-6 space-y-6">
            ...
            <!-- Section: Actions -->
            @include('livewire.admin.company.sections.actions')

            <!-- Section: Logo -->
            @include('livewire.admin.company.sections.logo')

            <!-- Section: Infos Entreprise -->
            @include('livewire.admin.company.sections.infos')

            <!-- Section: Autres Infos -->
            @include('livewire.admin.company.sections.autres')
