<div>
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Edit User: {{ $name }}</h2>
            </div>

            <form wire:submit.prevent="updateUser" class="mt-6">
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input wire:model.defer="password" type="password" placeholder="New Password" id="password"
                    ...
                    <div class="mb-6">
                        ...
                        <input wire:model.defer="password_confirmation" type="password" placeholder="Confirm New Password" id="password_confirmation"
